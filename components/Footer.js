      ...
      <div className={footer.footerContainer}>
          <div className={footer.socials}>
              <Link href={twitterLink}>
                <a className={`${footer.link} ${footer.Twitter}`} target='_blank'>Twitter</a>
              </Link>
              <Link href={linkedinLink}>
                <a className={`${footer.link} ${footer.LinkedIn}`} target='_blank'>LinkedIn</a>
              </Link>
              <Link href={githubLink}>
                  <a className={`${footer['link']} ${footer['GitHub']}`}>GitHub</a>
              </Link>
              <Link href={'https://www.supercolony.net'}>
                <a className={`${footer.link} ${footer.Website}`} target='_blank'>Supercolony</a>
              </Link>
          </div>
