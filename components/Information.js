    ...
    <div className={info.informationBlockWrapper}>
      ...
      <div className={info.contentWrapper}>
        <div className={info.grid}>
          <h3>
            Implementation of{' '}
            <Link href="https://github.com/w3f/PSPs">
          ...
          <ul>
            ...
            <li>
              <span>PSP34: Non-Fungible Token</span>
            </li>
            <li>
              <span>PSP1155: Multi-Token</span>
            </li>
          </ul>
          ...
          <ul>
            ...
            <li>
              <span>Mintable, Burnable</span>
            </li>
            <li>
              <span>Timelock, Payment Splitter</span>
            </li>
          </ul>
          ...
          <ul>
            ...
            <li>
              <span>Storage definition</span>
            </li>
            <li>
              <span>Trait definitions</span>
            </li>
          </ul>
        </div>
